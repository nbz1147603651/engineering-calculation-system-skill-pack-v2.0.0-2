...
dist/release/                                platform release zips and checksums
  engineering-calculation-system-CODEX-v2.4.4.zip
  engineering-calculation-system-MiniMaxCode-v2.4.4.zip
  engineering-calculation-system-ZCode-v2.4.4.zip
  engineering-calculation-system-QODER-v2.4.4.zip
  engineering-calculation-system-QODER-Project-v2.4.4.zip
  engineering-calculation-system-TRAE-v2.4.4.zip
  engineering-calculation-system-OpenCode-v2.4.4.zip
  engineering-calculation-system-AGENTS-Generic-v2.4.4.zip

tools/release_config.json                    release metadata and platform publish target config
```

`engineering-calculation-system-MiniMaxCode-v2.4.4.zip` keeps the standard root `SKILL.md` layout for MiniMax Code import or auto-discovery. `engineering-calculation-system-ZCode-v2.4.4.zip` installs the same core skill folder under `~/.zcode/skills/engineering-calculation-system/` for ZCode. `engineering-calculation-system-QODER-v2.4.4.zip` is a direct QODER Skill upload package with `SKILL.md` at the zip root. `engineering-calculation-system-QODER-Project-v2.4.4.zip` is the QODER project-root overlay package.
