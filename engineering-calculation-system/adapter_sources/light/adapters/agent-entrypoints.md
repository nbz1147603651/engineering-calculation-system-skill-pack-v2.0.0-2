...
1. Use `dist/release/engineering-calculation-system-MiniMaxCode-v2.4.3.zip`, or expose `dist/core/engineering-calculation-system/` as a standard `SKILL.md` skill folder.
...
1. Use `dist/release/engineering-calculation-system-ZCode-v2.4.3.zip`, or copy `dist/core/engineering-calculation-system/` to `~/.zcode/skills/engineering-calculation-system/`.
...
1. For project-root installation, use `dist/release/engineering-calculation-system-QODER-Project-v2.4.3.zip`.
