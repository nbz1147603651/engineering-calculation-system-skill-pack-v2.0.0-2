...
metadata:
  ...
  entrypoint: "../../../engineering-calculation-system/core/engineering-calculation-system/SKILL.md"
...
1. Read `../../../engineering-calculation-system/core/engineering-calculation-system/SKILL.md`.
2. Read `../../../engineering-calculation-system/core/engineering-calculation-system/skills/00-engineering-calculation-router.skill.md`.
3. Read only the parent and child skill files selected by the router.
4. For explicit multi-agent or parallel work, read `../../../engineering-calculation-system/core/engineering-calculation-system/shared/multi-agent-orchestration.md` and use `../../../engineering-calculation-system/core/engineering-calculation-system/templates/orchestration/`.
5. Use `../../../engineering-calculation-system/core/engineering-calculation-system/templates/`, `../../../engineering-calculation-system/core/engineering-calculation-system/shared/`, and `../../../engineering-calculation-system/core/engineering-calculation-system/schemas/` only when generating or validating artifacts.
...
Before enabling MCP servers, read `../../../engineering-calculation-system/core/engineering-calculation-system/adapters/mcp-recommendations.md` when that adapter file is present. Use MCPs as optional accelerators for search, docs lookup, public code search, diagnostics, and UI testing; never treat MCP output as authoritative engineering evidence without citation and validation.
